...
#ifdef _COSMIC_   //ten poni¿szy define, kiedy nie jest stosowany RTOS AtomThreads, w przeciwnym razie zakomentowaæ go
 #define INTERRUPT @far @interrupt @svlreg //bez tego svlreg nie dzia³a przekazywanie wartoœci zmiennej volatile miêdzy procedur¹ obs³ugi przerwania i pozosta³ymi fukcjami
#elif defined(_IAR_)
